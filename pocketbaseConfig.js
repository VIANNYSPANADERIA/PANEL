...
const PB_COLLECTIONS = Object.freeze({
  ...
  // Flujo de caja y deudas (pestaña de Costos y Rentabilidad)
  flujoConfig:         'flujo_config',
  proveedoresDeuda:    'proveedores_deuda',
  abonosDeuda:         'abonos_deuda'
});

/* Colecciones que pueden no existir todavía en el servidor: si faltan, la app
   sigue funcionando (guarda en la copia local) y no muestra error al arrancar. */
const PB_OPCIONALES = new Set(['flujoConfig', 'proveedoresDeuda', 'abonosDeuda']);
...
window.PB_OPCIONALES = PB_OPCIONALES;
